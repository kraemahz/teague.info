(function (factory) {
  ...
  let FrontMatter$1 = class FrontMatter {
    constructor() {
...
`;
  ...
  function requirePrismJulia() {
    if (hasRequiredPrismJulia) return prismJulia;
...
`);
  class Code extends Mutating(T$8(HTMLElement)) {
    renderContent() {
      ...
      const language = Prism$1.languages[this.languageName];
      ...
      codeTag.innerHTML = Prism$1.highlight(content, language);
    }
  }
...
`, false);
  ...
  class Figure extends HTMLElement {
    ...
    static runReadyQueue() {
      ...
      const figure = Figure.readyQueue.sort((a, b) => a._seenOnScreen - b._seenOnScreen).filter(figure => !figure._ready).pop();
      if (figure) {
        figure.ready();
...
`);
  ...
  function interpolate (a, b) {
    var t = typeof b,
      c;
    return b == null || t === "boolean" ? constant$2(b) : (t === "number" ? interpolateNumber : t === "string" ? (c = color(b)) ? (b = c, rgb) : string : b instanceof color ? rgb : b instanceof Date ? date : isNumberArray(b) ? numberArray : Array.isArray(b) ? genericArray : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object : interpolateNumber)(a, b);
  }
...
`);
  ...
  class Slider extends T$2(HTMLElement) {
    connectedCallback() {
      ...
      this.renderTicks();
      this.drag = drag().container(this.background).on('start', event => {
...
`;
  ...
  const initialize = function () {
    ...
    const components = [Abstract, Appendix, Article, Bibliography, Byline, Cite, CitationList, Code, Footnote, FootnoteList, FrontMatter, HoverBox, Title, DMath, References, TOC, Figure, Slider, Interstitial];
