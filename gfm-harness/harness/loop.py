...
class HarnessSession:
    ...
    # Control-flow signal for the Agent SDK driver. When the agent calls
    # pause_for_user, the tool handler sets this field to the PauseForUser
    # exception instance. The driver's can_use_tool callback checks this
