...
The gap is closed structurally. The companion
paper~\citep{lasser2026foundations} establishes that under four
operationally auditable structural conditions ---
representativeness (REP), bounded dispersion (DISP), coalition
closure (COAL), and Lipschitz embedding compatibility (EMB)
(collected as Assumption~\ref{ass:concgap_conditions} of
...
deployment theorem binds via
\citep[Theorem~2]{lasser2026foundations}'s upper bound.  Each of (REP),
...
$I_5$ depends on Assumption~\ref{ass:concgap_conditions}'s four
operationally auditable structural conditions; the universal
Concentration-Gap conjecture is not part of the deployment
claim's dependency chain. The other ten invariants are
theorem-proof conditions derived from established source-paper
machinery. See \S\ref{sec:conjecture_audit} for the dependency
structure and \S\ref{sec:disc_indefinite} for the universal
conjecture's status as a deferred-indefinitely target.
