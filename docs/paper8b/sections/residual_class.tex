...
(\citep{lasser2026paper8a}) that emits a valid
...
(the exercise indicator~\citep{lasser2026paper8a}), by contrast, sums
...
$e_t(d_k) = 1$ under
the exercise indicator~\citep{lasser2026paper8a}.  Active presence within
...
poset-independent (the category partition~\citep{lasser2026paper8a}(i))
...
(the $\volR$ definition~\citep{lasser2026paper8a}), $d_k \in P^{\mathrm{ex}}_W =
...
axiom~M4~\citep[Proposition~1]{lasser2026poset}, giving the sum
...
the exercise indicator~\citep{lasser2026paper8a}.
\end{proof}
...
(the exercise indicator~\citep{lasser2026paper8a}, conditions BC1/BC2),
the OI floor contributes exclusively to $\volRexact(O)$ in the
combined diagnostic (the exercise-indicator appendix of~\citep{lasser2026paper8a}):
\[
...
in~\citep{lasser2026paper8a}); the OI floor's contribution is
