...
money, no time displaced from any wage-imputable or
otherwise-pricable activity (``idle cycles'' here means time
intervals during which the agent is not also engaged in any
sacrifice-attributable activity; this is itself a
poset-construction stipulation rather than a formally derived
property---a stricter reading might attribute opportunity-cost
even to idle time), no counterparty, so
