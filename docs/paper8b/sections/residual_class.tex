...
diagnostic
(the exercise indicator~\citep{lasser2026paper8a}), by
...
agent set; the category partition of~\citep{lasser2026paper8a}
...
that $t$.  Under the window-integrated form of the companion
paper's $\volR$ definition~\citep{lasser2026paper8a}, $d_k \in
P^{\mathrm{ex}}_W =
