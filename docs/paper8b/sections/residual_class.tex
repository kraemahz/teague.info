...
(\citep[paper~8a]{lasser2026paper8a}) on the underlying bundle.  Whether
...
diagnostic
(the exercise indicator~\citep[paper~8a]{lasser2026paper8a}), by
...
$e_t(d_k) = 1$ under
the exercise indicator~\citep[paper~8a]{lasser2026paper8a}.  Active presence within
...
agent set; the category partition of~\citep[paper~8a]{lasser2026paper8a}
...
paper's $\volR$ definition~\citep[paper~8a]{lasser2026paper8a}, $d_k \in
...
of the companion paper~\citep[paper~8a]{lasser2026paper8a}.  Without the
...
(the exercise indicator~\citep[paper~8a]{lasser2026paper8a}, conditions BC1/BC2),
the OI floor contributes exclusively to $\volRexact(O)$ in the
combined diagnostic (the exercise-indicator appendix of~\citep[paper~8a]{lasser2026paper8a}):
\[
...
in~\citep[paper~8a]{lasser2026paper8a}); the OI floor's contribution is
