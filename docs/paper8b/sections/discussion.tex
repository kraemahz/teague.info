...
$\{R, C, D, S, B\}$ follows from set-disjoint M5 weight
summation alone, with no poset-boundary closure required.
...
required since the identity follows from set-disjoint M5
