...
in which retention is the sole non-degrading alternative are
involuntary and correctly filtered by S1
(Proposition~\ref{prop:s1_sufficiency}); below-sufficiency
targeting where a third alternative exists requires
institutional attestation to classify.  The need-access cost
