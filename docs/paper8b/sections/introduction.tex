...
from the aggregate.  Other S1 failure modes (below-sufficiency targeting with a
third alternative available; coercion; duress; information asymmetry) require
institutional attestation rather than this structural filter
...
\item \textbf{Need-sufficiency architecture
  ...
  aggregate~\citep[Revealed~Sacrifice]{lasser2026paper8a}.  A
