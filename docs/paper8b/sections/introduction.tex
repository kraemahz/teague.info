...
(Definition~\ref{def:s1_sufficiency}): events in which
...
\item \textbf{Gap decomposition
  ...
  \betaL = \sum \delta$ under poset-boundary closure
  (strategies (a)/(b)), or a five-cell variant with an
  additional boundary-residual bucket under the
  literal-partition variant (strategy (c)).  Supplies a
