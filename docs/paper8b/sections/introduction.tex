...
\item \textbf{Need-sufficiency architecture
  ...
  sacrifice unambiguously reveals preference strength and
  enters the companion paper's
  aggregate~\citep[Revealed~Sacrifice]{lasser2026paper8a}.
  Below-sufficiency targeting where a third non-degrading
  alternative is available, and above-sufficiency events with
  other S1 failure modes (coercion, duress, information
  asymmetry), are intermediate cases that the
  structural filter does not classify on its own; they require
  institutional attestation to determine S1-admissibility.  A
