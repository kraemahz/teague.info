...
The companion paper~\citep[paper~8a]{lasser2026paper8a} proves the
...
\item \textbf{Need-sufficiency architecture
  ...
  aggregate~\citep[paper~8a]{lasser2026paper8a}.  A
...
The companion paper~\citep[paper~8a]{lasser2026paper8a} establishes the
...
\begin{tabular}{@{}ll@{}}
\toprule
\textbf{Companion paper} (\citep[paper~8a]{lasser2026paper8a})
  & \textbf{This paper} \\
\midrule
...
package as~\citep[paper~8a]{lasser2026paper8a}; reviewers should have
...
paper~\citep[paper~8a]{lasser2026paper8a}.  A summary dependency table is
