...
\item \textbf{Covered cell:} $C := \CovS \setminus \Xi$, where
  ...
  (the event-local bundle decomposition~\citep{lasser2026paper8a}).
...
\medskip\noindent
\textbf{Poset-boundary closure hypothesis.}  We additionally
require the partition $\{R, C, D, S\}$ to be
\emph{poset-boundary closed}, meaning both:
\begin{enumerate}
...
across cells; by the category partition~\citep{lasser2026paper8a}(i) and
the M4 axiom inherited from
Proposition~1~\citep{lasser2026poset}, additivity requires full
poset-independence---\emph{neither} cross-cell cooperative
composition \emph{nor} cross-cell subsumption.  A cooperative
