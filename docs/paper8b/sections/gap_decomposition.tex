...
companion paper~\citep[paper~8a]{lasser2026paper8a} on the full
...
theorem of the companion paper~\citep[paper~8a]{lasser2026paper8a}
(S0--S5), the per-capability aggregate $\volRlower(c)$ is
well-defined, and subset aggregates $\volRlower(A)$ are given
by the subset-extension of $\volRlower$~\citep[paper~8a]{lasser2026paper8a}.  Under those
...
\item \textbf{Seed covered cell:} $C_0 := \CovS \setminus \Xi$,
  ...
  decomposition~\citep[paper~8a]{lasser2026paper8a}).
...
example, with the additivity identity following from
set-disjoint M5 weight summation alone (no M4 invocation).
...
condition of the companion paper~\citep[paper~8a]{lasser2026paper8a} and
...
\citep[paper~8a]{lasser2026paper8a}, the second because $\volR$ is
...
$\volRlower$~\citep[paper~8a]{lasser2026paper8a}, applied to the
...
(the aggregate lower bound theorem~\citep[paper~8a]{lasser2026paper8a}), the full Part~B
admissibility set is required: S0, S1, S2, S4(a), S3, S5, the
genuine-exchange conditions (i)--(iv) of
the revealed-sacrifice event definition~\citep[paper~8a]{lasser2026paper8a}, \emph{and} within-bundle
poset-independence per the event-local bundle decomposition~\citep[paper~8a]{lasser2026paper8a}; and
...
the event-local bundle decomposition~\citep[paper~8a]{lasser2026paper8a}---accumulate the
...
(\citep[paper~8a]{lasser2026paper8a}), the labelling is carried by the
...
paper~\citep[paper~8a]{lasser2026paper8a}), the
decomposition operates at the category level: each partition
component $C_j$
(the category partition~\citep[paper~8a]{lasser2026paper8a}) is classified as
restricted, covered, dormant, or residual.  Under committed data
(\citep[paper~8a]{lasser2026paper8a}), S2 is not directly verifiable;
...
paper~\citep[paper~8a]{lasser2026paper8a} or
...
paper~\citep[paper~8a]{lasser2026paper8a} would tighten $\NAC$ to
...
(\citep[paper~8a]{lasser2026paper8a}), per-agent $\NSE(i, N)$ is not
...
decomposition via the aggregate lower bound theorem~\citep[paper~8a]{lasser2026paper8a}; events
