...
(\citep[paper~8a]{lasser2026paper8a}) assumes all sacrifices have
...
\citep[paper~8a, Appendix~A]{lasser2026paper8a}) directly observe
...
(\citep[paper~8a]{lasser2026paper8a}) becomes structurally
...
(\citep[paper~8a]{lasser2026paper8a}) directly: H2 asserts that no
...
theorem~\citep[paper~8a]{lasser2026paper8a}).  Below-sufficiency
...
paper~\citep[paper~8a]{lasser2026paper8a}) remain.
\end{remark}
...
paper~\citep[paper~8a]{lasser2026paper8a} (the external-attestation
...
the aggregate lower bound theorem~\citep[paper~8a]{lasser2026paper8a} does not, by itself, address.
...
companion paper's sacrifice channel~\citep[paper~8a]{lasser2026paper8a}
