...
\item \textbf{Below sufficiency on some dimension, but a
  ...
  institutional review (Definition~\ref{prop:s1_sufficiency}
...
Definition~\ref{prop:s1_sufficiency}; above sufficiency, this
specific failure mode does not apply (though S1 can still fail
via other mechanisms---see
Definition~\ref{prop:s1_sufficiency} and
...
(\citep{lasser2026paper8a}) directly: H2 asserts that no
...
Definition~\ref{prop:s1_sufficiency} is operational: it picks
...
Definition~\ref{prop:s1_sufficiency} and does not imply S1
...
Definition~\ref{prop:s1_sufficiency} above, which is
