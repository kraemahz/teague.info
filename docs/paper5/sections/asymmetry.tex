...
growth while actual $\volL$ stagnates.  In a prototype
implementation, this manifested as a capability self-assertion
gradient: an agent that adds capabilities to its own ledger entry
is both claimant and observer
(\S\ref{sec:ver_failures}).
