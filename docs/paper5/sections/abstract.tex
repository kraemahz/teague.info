\begin{abstract}
    ...
    modify the evaluator's inputs---and this asymmetry grows
    ...
    commitment protocol (binding, hiding, zero-knowledge) enforces the
    ...
    observation-channel integrity assumption of Paper~4's multi-channel
