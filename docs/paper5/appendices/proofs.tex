...
Isolation) provides the adversarially robust result requiring only
substrate exclusivity; Proposition~\ref{prop:channel_independence}
(Channel Independence) strengthens to full conditional independence
under additional sufficiency and independent-randomness assumptions.
...
the two results: isolation is the adversarially load-bearing property,
and independence is the additional statistical guarantee available
when the agent's capability profile is an accurate summary of its
