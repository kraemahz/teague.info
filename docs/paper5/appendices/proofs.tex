...
(Anti-Monopolar Verification)}
\label{app:anti_monopolar}

The proof in \S\ref{sec:anti_monopolar} is already complete.  We
provide an extended discussion of the theorem's consequences.

\paragraph{Relationship to Paper~3's anti-monopolar result.}
...
\emph{undetectable from within the population}.

The two results compose multiplicatively.  Paper~3 says: ``if you
