...
\citep{lasser2026horizon} establishes the anti-monopolar
...
identified in the gap analysis across the GFM sequence and share a common
...
\citep{lasser2026exo}'s cryptographic commitment protocol.
That paper ensures channels are honest; this paper ensures enough honest
channels survive.
...
\midrule
Foundational~\citep{lasser2026gfm} & Self-trust $T_s$ (Appendix B) & Restoring force: self-correction via prediction residuals \\
Poset~\citep{lasser2026poset} & Axiom verification (Prop.\ 1), leverage & Properties of $\volL$ the dynamics preserves or violates \\
Horizon~\citep{lasser2026horizon} & Anti-monopolar property (Prop.\ 6) & Starting point: the linearized growth model we extend \\
Horizon & Structural discovery value (Prop.\ 2) & Self-correction force in feedback loop 1 \\
Horizon & Substrate physics (Defs.\ 10, 12--13) & Substrate partition the phase boundary is defined over \\
Causal~\citep{lasser2026scm} & Multi-channel architecture (Table~1) & Instances of observation channels \\
Causal & Risk-trust $L^2$ convergence (Prop.\ 2) & Template for bounding correction rates \\
Verification~\citep{lasser2026exo} & Channel isolation \& independence & Integrity conditions on observation channels \\
\bottomrule
\end{tabular}
\caption{Dependencies on prior GFM results. Short names: Foundational = \citet{lasser2026gfm}, Poset = \citet{lasser2026poset}, Horizon = \citet{lasser2026horizon}, Causal = \citet{lasser2026scm}, Verification = \citet{lasser2026exo}.}
