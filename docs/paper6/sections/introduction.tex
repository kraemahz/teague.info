...
\item \textbf{The phase boundary theorem}
  ...
  zero whose radius shrinks as subsumption ceases.  Once inside
  that neighborhood the anti-monopolar property applies.  Above the
  boundary, the system enters an absorbing basin (under full
