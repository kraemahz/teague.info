...
anti-monopolar result~\citep[Proposition~6]{lasser2026horizon}, which compares discounted
...
strictly weaker results: it cannot invoke the $\gamma^*$
threshold~\citep{lasser2026horizon}, and the self-correction
guarantee applies only to immediate
