...
absorbing regime (no cross-substrate witness, Theorem~1(b)
triggers) while dimensions 1 and 2 remain in the self-correcting
regime.  The actor's world model on dimension~3 is unverifiable,
while its world model on dimensions 1 and 2 remains calibrated.
