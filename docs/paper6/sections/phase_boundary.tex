...
simplified condition uses the inf bound.)  The left-hand side has two
terms: the exogenous correction $\rS \cdot \rhomincross$ (proportional
to channel strength) and the endogenous incentive $c_{\mathrm{V}}
\cdot \underline{\nu}$ (the actor's own $\volL$-gradient toward better
calibration, independent of channel count).  The endogenous term
...
Solving for the critical cross-substrate redundancy:
\begin{equation}
...
$c_{\mathrm{V}} \cdot \underline{\nu}$ alone exceeds the right-hand
