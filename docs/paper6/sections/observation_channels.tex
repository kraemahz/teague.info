...
This connects to Paper~4's multi-channel architecture
(Table~1 of~\citet{lasser2026scm}): the five channels (capability
...
\item[(b)] \emph{Channel independence} (conditional on the
  joint-factorization assumption from Paper~5, Section~8.1): channel
