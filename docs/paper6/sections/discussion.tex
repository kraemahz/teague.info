...
\citet{lasser2026exo} addresses observation-channel integrity; this paper analyzes
the dynamical consequences of channel \emph{availability}.
The combination is: exogenous verification ensures channels are honest, this paper
ensures enough honest channels survive.  A joint treatment---where
the phase boundary accounts for both integrity failures~\citep{lasser2026exo} and
