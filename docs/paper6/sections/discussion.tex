...
The connection to prediction markets is immediate.  In a
multi-agent setting, the verification ledger generalizes to a
prediction market: agents commit predictions, stake reputation
on outcomes, and calibration is scored publicly.  The market's
