...
\end{equation}
whenever $\Lyap(\Wm_t) > 0$, where
$\nu(P_t, \Wm_t) = \bigl|\partial \volL(G_t) / \partial
\Lyap(\Wm_t)\bigr|$ is the $\volL$-sensitivity to calibration
improvement.
\end{assumption}
...
\nu$ term tips the balance toward the stabilizing side.
\end{remark}
