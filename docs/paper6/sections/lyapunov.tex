...
rule structure in the risk-trust model of~\citet{lasser2026scm}: each observed channel
...
across cross-substrate channels follows from the channel
independence property~\citep{lasser2026exo} under the joint-factorization assumption.
