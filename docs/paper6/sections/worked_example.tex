...
\end{equation*}
Satisfied with margin.  The contraction condition holds, and in the
self-correcting basin (provided the resulting neighborhood radius
$\Lyap_\infty < \epsilon_{\mathrm{safe}}$; see
...
mechanism $T_s$~\citep{lasser2026gfm} depends on accurate self-assessment; when
...
all dimensions enter net degradation.  Once $\rhocross_k \to 0$ on the failing
