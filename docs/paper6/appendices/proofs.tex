...
$1 - \bar{a} = \rSeff \cdot \rhomincross - \rW \cdot \rsub$
(amortized contraction rate, with $\rSeff$ using the inf bound on the
endogenous term from C1) yields the explicit radius.  This neighborhood shrinks as $\Delta\rho \to 0$
