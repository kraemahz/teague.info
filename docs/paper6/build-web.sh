#!/usr/bin/env bash
# Build the Distill HTML version of Paper 6.
# Usage: ./build-web.sh
# Output: ../../public/papers/phase/index.html
...
OUT_DIR="$SCRIPT_DIR/../../public/papers/phase"
...
# Resolve cross-references for Paper 6
# Numbers from main.aux after pdflatex build.
ref_map = {
    # Sections
    'sec:introduction': '1',
    'sec:coupled_system': '2',
    'sec:observation_channels': '3',
    'sec:lyapunov': '4',
    'sec:absorbing_state': '5',
    'sec:phase_boundary': '6',
    'sec:unified_loops': '7',
    'sec:design_criterion': '8',
    'sec:worked_example': '9',
    'sec:discussion': '10',
    # Appendices
    'app:proofs': 'A',
    'app:proof_strategy': 'A.1',
    'app:cascade': 'A.2',
    'app:gamma_star': 'A.3',
    'app:notation': 'B',
}
...
{
  "title": "Phase Boundaries for Compound Feedback Loops in Goal-Frontier Maximization",
  "description": "Formalizes the phase boundary separating self-correcting trajectories from absorbing monopolar states in coupled (poset, world-model) dynamics, unifying three compound feedback loops under a single Lyapunov stability framework.",
  "authors": [
    {
...
<d-title>
  <h1>Phase Boundaries for Compound Feedback Loops in Goal-Frontier Maximization</h1>
  <p style="margin-top: 0.5em;"><a href="/papers/phase/phase.pdf" style="color: #666; text-decoration: none; border-bottom: 1px solid #ccc;">📄 Download PDF version</a></p>
</d-title>
...
if [ -f "$PAPER_DIR/main.pdf" ]; then
    cp "$PAPER_DIR/main.pdf" "$OUT_DIR/phase.pdf"
    echo "PDF copied to $OUT_DIR/phase.pdf"
fi
