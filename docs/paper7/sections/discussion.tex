...
composition rule fixes the design parameter: for a target
window false-negative rate $\epsilon_\beta$ and a known (or
upper-bounded) pathway duration $k$, the per-step detection
...
$k$ the requirement softens proportionally.  Implementations
...
total $\volL$ lost to adversarial claims before
trust-weight downweighting takes effect is bounded above by
...
window each claim ties up the targeted capability.  In
