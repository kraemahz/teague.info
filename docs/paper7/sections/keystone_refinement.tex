...
may still admit refinement.  The choice between Mode A and
Mode B testing is itself a verification-asymmetry problem one
level up: the existence of a viable
$\keystonestruct_{\mathrm{narrow}}$ cannot be observed without
running the refinement test.  Domain expertise or structural
discovery~\citep[Proposition~2]{lasser2026horizon} supplies the
prior that guides test-mode selection; the protocol provides
the empirical resolution once the candidate is named.
\end{remark}
