...
\item If $\volL$-contraction within $\scope$ exceeds $\damagebound$
  at any step, immediately reinstate $\Xirestrict$ and terminate
  the test early (safety cutoff).
\end{itemize}
...
$\rS = 0$ for that
loop~\citep[Proposition~3]{lasser2026phase}.  The self-correction
