...
implementation parameter, not a theoretical one: different agents may use
different discount factors depending on their planning capacity and the
timescale of the problems they face.
...
Let $\volL$ satisfy axioms M1--M6 (Proposition~1 of \citet{lasser2026poset}).
