#!/usr/bin/env bash
# Build the Distill HTML version of Paper 3.
# Usage: ./build-web.sh
# Output: ../../public/papers/horizon/index.html
...
OUT_DIR="$SCRIPT_DIR/../../public/papers/horizon"
...
# Resolve cross-references for Paper 3
ref_map = {
    # Theorem
    'thm:discounted_self_balancing': '1',
    # Propositions
    'prop:preemptive': '1',
    'prop:structure_value': '2',
    'prop:anti_monopolar': '3',
    # Corollaries
    'cor:a1_from_oi': '2.1',
    'cor:gradual': '3.1',
    # Remarks
    'rem:verification': '1',
    'rem:obs_cost': '2',
    'rem:leverage_preservation': '3',
    # Definitions
    'def:discounted': '1',
    'def:exercise_pathway': '2',
    'def:concentration_risk': '3',
    'def:risk_claim': '4',
    'def:info_value': '5',
    'def:dominant': '6',
    'def:growth_rate': '7',
    'def:distinguishable': '8',
    'def:obs_individuation': '9',
    # Sections
    'sec:introduction': '1',
    'sec:discounted': '2',
    'sec:risk': '3',
    ...
    'sec:avoidance': '5',
    'sec:substitution': '6',
    'sec:obs_individuation': '6.3',
    'sec:gradual': '6.5',
    'sec:substitution_coop': '6.6',
    'sec:discussion': '7',
    'sec:conclusion': '8',
    # Appendices
    'app:proofs': 'A',
    'app:proof_preemptive': 'A.1',
    'app:proof_structure_value': 'A.2',
    'app:proof_anti_monopolar': 'A.3',
}
...
ref_map = {'prop:anti_monopolar': '3', 'cor:a1_from_oi': '2.1', 'cor:gradual': '3.1'}
def resolve_ref(m):
...
<script type="text/json">
{
  ...
  "description": "Multi-step goal-frontier maximization with risk-capability identification, the verification asymmetry, and the anti-monopolar property showing endogenous pressure against singleton behavior.",
  "authors": [
    {
...
<d-title>
  <h1>Horizon-Aware Goal-Frontier Maximization and the Anti-Monopolar Property</h1>
  <p style="margin-top: 0.5em;"><a href="/papers/horizon/horizon.pdf" style="color: #666; text-decoration: none; border-bottom: 1px solid #ccc;">📄 Download PDF version</a></p>
</d-title>
...
if [ -f "$PAPER_DIR/main.pdf" ]; then
    cp "$PAPER_DIR/main.pdf" "$OUT_DIR/horizon.pdf"
    echo "PDF copied to $OUT_DIR/horizon.pdf"
fi
