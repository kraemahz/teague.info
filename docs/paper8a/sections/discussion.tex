...
dominates either channel alone; strict domination obtains at
the non-fungibility residuals (agent-specific time,
capital-concentrated access) when the trade window contains an
event in the relevant residual category.  ``Weakly dominates''
