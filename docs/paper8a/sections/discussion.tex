...
upper-bounds $1 - \betaL$) on the observed subset, under S0--S2
and S4(a).  Because $\betaL \leq \beta = \volR/\volL$ by
construction, this also lower-bounds the true exercised fraction
$\beta$ on the observed subset; the constructed object is
$\betaL$ and the true $\beta$ is bounded only as a consequence,
