...
all direct measurement.  This is a structural finding, not a
...
sacrifice-channel ratio $\betaL = \volRlower / \volL$, which is
itself a lower bound on the true exercised fraction
$\beta = \volR/\volL$ (since $\volRlower \leq \volR$ by
construction).  Equivalently, $1 - \betaL \geq 1 - \beta$
upper-bounds the true B-to-C gap from above.  Both inequalities
hold on the observed subset under S0--S2, S4(a), and the
