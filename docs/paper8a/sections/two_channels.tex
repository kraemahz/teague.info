...
identification).  \emph{Admissibility cap.}  S0 implicitly
caps $\Delta\volL(X(r_i \cdot h))$ at the bundle's
window-active $\volR$ ceiling
$\sum_{c \in Y} w(c)$; events where the wage-imputed magnitude
exceeds this ceiling violate S0 and are inadmissible
