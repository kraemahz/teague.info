...
only trades satisfying S1's non-degradation are admitted as
sacrifice events; the need-sufficiency architecture developed
in the companion paper~\citep{lasser2026paper8b} supplies the
structural filter and polarity-boundary mechanism for this; (b)~the category partition
