...
\emph{exercise}~($\volR$).  Direct measurement of $\volR$ would
require panopticon-scale observation, which the framework's
...
inequality showing $Y$'s realized contribution is at least
$X$'s benchmark magnitude.  Aggregating across events with
...
of~\citep{lasser2026exo} to produce a privacy-minimal public
aggregate on distinct-category batches.  Money and time
