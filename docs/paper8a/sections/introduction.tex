...
\item \textbf{Aggregate B-to-C Lower Bound}
  ...
  denominator.  The subset-local ratio is sharp on $U$; the
  global ratio is a lower bound on the true whole-system
  exercised fraction.  We write simply $\betaL$ when the choice
  of $G$ is fixed by context.  Part~A
