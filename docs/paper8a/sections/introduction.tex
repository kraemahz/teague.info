...
equivalently an upper bound on the B-to-C gap $1 - \beta$ on
that subset.
...
paper~\citep{lasser2026paper8b} and the earlier sequence
...
are presently distributed as preprints; the present paper's
results are stable against versioning of those preprints
(specific cited propositions/definitions are stable; minor
prose revisions in the dependencies do not change the
imported facts).  Stable archival identifiers will be added
