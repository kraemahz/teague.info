...
of~\citep[Horizon~Aware]{lasser2026horizon} extends to multi-substrate
...
\item \textbf{Commitment-layer composition}
  ...
  of~\citep[Exogenous~Verification]{lasser2026exo} to produce a privacy-minimal
...
with~\citep[Phase~Redundancy]{lasser2026phase} and~\citep[Controlled~Relaxation]{lasser2026wamura}:
\textbf{resolution through frequency, not through depth.}
Controlled relaxation~\citep[Controlled~Relaxation]{lasser2026wamura} gains precision
