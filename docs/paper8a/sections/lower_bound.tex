...
\item For the restriction set $\Xi$, residual class $\ResS$,
  and other capability subsets used in the companion paper's
  gap decomposition~\citep{lasser2026paper8b}:
...
gap-decomposition and wireheading-detection machinery
of~\citep{lasser2026paper8b} is stated under Part~B semantics
