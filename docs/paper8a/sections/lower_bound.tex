...
\item For any other capability subset $A \subseteq P$
  (e.g., a restriction set, residual class, or diagnostic
  cell), $\volRlower(A)$ is defined analogously as the sum
  over $A \cap U$.
\end{itemize}
...
$\volR^U \geq \sum_n \Delta\volL(X_n)$ are available.  The
companion paper's gap decomposition and wireheading diagnostic
(\citep{lasser2026paper8b}, downstream applications) are stated
