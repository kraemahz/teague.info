...
\item[S1 (Free choice).] Each sacrifice event is a voluntary
  ...
  (see the companion paper~\citep{lasser2026paper8b} for the
  need-sufficiency architecture that filters such
  below-sufficiency events structurally).
...
\item[\textbf{(P5)}] \textbf{Third-party observability
  ...
  sacrifice magnitude $\Delta\volL(X)$ is directly readable from
  the price paid.
