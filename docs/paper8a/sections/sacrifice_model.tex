...
\item[S1 (Free choice).] Each sacrifice event is a voluntary
  ...
  and the agent had \emph{non-degrading} alternatives:
  ...
  $X_n$ would put the agent below-sufficiency or in which the
  material-confound conditions are violated, and the
