...
violating Definition~\ref{def:bundle_decomp}.  S5 is a substantive empirical assumption, not automatically
satisfied by any single default.  The equal-weight default
...
a verifiable link to an underlying trade record.  ``Valid
revealed-sacrifice event'' in the strict sense---all of S0,
S1, S2, S3, S4(a), S5, and the genuine-exchange
conditions---is not what the proof certifies; the
non-objective hypotheses remain external attestations
(Remark~\ref{rem:zk_limits}).  This is the event-level
