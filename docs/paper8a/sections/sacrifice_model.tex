...
\item[S1 (Free choice).] Each sacrifice event is a voluntary
  ...
  developed in the companion paper~\citep[Need~Sufficiency]{lasser2026paper8b}.
...
subjective valuation and realized exercise---neither directly
observable in the sacrifice channel.  No
...
a verifiable link to an underlying trade record.  ``Valid revealed-sacrifice event'' in the strict sense---all
of S0, S1, S2, S3, S4(a), and the genuine-exchange
conditions (with S4(b) and S5 additionally for Part~B)---is
not what the proof certifies; the non-objective hypotheses
remain external attestations (Remark~\ref{rem:zk_limits}).  This is the event-level
