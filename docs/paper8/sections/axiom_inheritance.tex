...
\item[(M4) Additivity under disjointness (substantive).]
  Satisfied for poset-independent bundle categories
  (Definition~\ref{def:category_partition}).  This is the
  load-bearing inheritance that makes the aggregate bound
  compose across events (Theorem~\ref{thm:aggregate_bound},
  Part~A, M4 application).
