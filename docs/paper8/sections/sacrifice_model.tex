...
The need-sufficiency architecture of the next section
characterizes when S1 fails structurally and provides the filter
that keeps the sacrifice channel clean.
