...
The natural response is to define \emph{realized capability volume}
$\volR$---a measure over exercised capabilities---and monitor the
ratio $\beta = \volR / \volL$.  An earlier formulation of this
paper attempted exactly that, defining an exercise indicator
$e_t(d) = 1$ iff removing capability~$d$ from the poset would make
some realized cooperative output unrealizable (a structural
