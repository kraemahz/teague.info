...
\item \textbf{Aggregate B-to-C Lower Bound}
  ...
  events.  Two levels: Part~A (bundle-level, requires S0--S2
  and S4(a)) is the main result; Part~B (per-capability,
  requires S0--S5) is a conditional refinement.  The constructed
