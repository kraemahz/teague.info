...
\item \textbf{Privacy-minimal observation channel}
  ...
  holds, and satisfies five privacy properties
...
\item \textbf{Aggregate B-to-C Lower Bound}
  ...
  levels: Part~A (bundle-level, requires S0--S2 and S4(a)) and
  Part~B (per-capability, requires S0--S5).  The bound tightens
