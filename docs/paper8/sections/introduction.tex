...
\item \textbf{Need-sufficiency architecture}
  ...
  construction.  General M5 capability-stuffing is identified
  as an open problem whose resolution path---capability
  provenance---is summarized in
  Section~\ref{sec:capability_stuffing} and deferred to
