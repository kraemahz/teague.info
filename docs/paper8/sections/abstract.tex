...
The Goal-Frontier Maximization framework's central measure, $\volL$, quantifies
    ...
    the framework lower-bounds the exercised fraction $\beta$ (equivalently,
    upper-bounds the B-to-C gap $1-\beta$) in terms of aggregated sacrifice
    magnitudes, under assumptions S0--S2 and S4(a) of the revealed-preference
    model.  This converts a previously-uncharacterized divergence into a
    bounded one, with the lower bound non-decreasing in observed
    admissible events.  The parallel need-sufficiency
