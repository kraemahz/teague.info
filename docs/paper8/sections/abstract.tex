...
The Goal-Frontier Maximization framework's central measure, $\volL$, quantifies
    ...
    observed admissible events (via sub-batch supremum for the Part~A
    bound and per-capability max-attribution for the Part~B refinement).  The parallel need-sufficiency
