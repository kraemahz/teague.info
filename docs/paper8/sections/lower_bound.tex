...
boundary-closed from $P \setminus O$ (no cooperative capability
splits across the boundary); a conservative lower bound
otherwise (Appendix~\ref{app:exercise_indicator},
