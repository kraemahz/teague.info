...
\Ui[_n](H_n)$ for pre-trade holdings $H_n$.  By S4(a) (global
valuation additivity) together with the genuine-exchange
conditions of Definition~\ref{def:sacrifice_event}
($X_n \cap Y_n = \emptyset$ and
$Y_n \cap (H_n \setminus X_n) = \emptyset$), the cancellation
$\Ui[_n]\bigl((H_n \setminus X_n) \cup Y_n\bigr) - \Ui[_n](H_n)
= \Ui[_n](Y_n) - \Ui[_n](X_n)$ holds, reducing the comparison
to $\Ui[_{n}](Y_n) \geq \Ui[_{n}](X_n)$.  By S0 (calibration),
