...
(Proposition~\ref{prop:privacy_institutional}), and composes with
...
$1 - \beta$) on the observed subset, under assumptions S0--S2
and S4(a).  The constructed lower bound is non-decreasing in
...
$\volR$ exhibits \emph{non-invariance under capability
...
independent of the observation mechanism and applies to the
measure $\volR$ itself, not just the lower-bound
$\volRlower$.
...
individual-agent S0 and motivate a population-level
weakening include: (i) \emph{ritualized payment}, where a
transaction's nominal price is symbolic rather than exchange-
valued (a token fee to ``soften'' receiving something for free);
