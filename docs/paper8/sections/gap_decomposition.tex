...
S2, and S4(a) for Part~A; S0--S5 for Part~B), and
...
satisfying S0/S1/S2 (input (v)), update $c$'s class from
dormant to covered (if not already restricted or residual).
This is $O(E)$ total work, one constant-time update per record.
