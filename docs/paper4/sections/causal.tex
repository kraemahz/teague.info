...
additional auxiliary procedure, such as regressing $\Deltahat$
...
\item \textbf{Correlational co-occurrence.} The trust-weighted
    ...
    $\volL$-contraction. This is a cheap channel to fake
    (an adversary can introduce uncorrelated dummy actions) and is
...
suspect. This paper does not formalize the joint hypothesis
